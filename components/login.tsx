      ...
      <div className="flex-grow pt-20 pb-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center bg-gradient-to-r from-purple-700 to-indigo-800">
        <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg">
          ...
          <div className="text-sm text-center">
            ...
            <Link
              href="/signup"
              className="inline-block mt-2 bg-gradient-to-r from-purple-700 to-indigo-800 text-white px-8 py-1.5 rounded-full hover:opacity-90 transition-opacity text-lg"
            >
              Sign Up
            </Link>
          </div>
