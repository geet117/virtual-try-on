        ...
        <section className="bg-gradient-to-r from-purple-700 to-indigo-800 text-white py-20 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl font-bold mb-6">
              Transform Your E-Commerce with Virtual Try-Ons
            </h1>
            <p className="text-3xl font-bold mb-8">CLICK. TRY. BUY.</p>
            <p className="text-xl mb-8">
              Boost sales and reduce returns with our cutting-edge virtual trial
              room technology
            </p>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} Virtual Try. All rights
              reserved.
            </p>
          </div>
        </div>
